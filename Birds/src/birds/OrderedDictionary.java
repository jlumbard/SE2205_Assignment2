...
public class OrderedDictionary implements OrderedDictionaryADT{
    ...
    public BirdRecord find(DataKey k) throws DictionaryException {
        ...
        return temp.GetBirdRecord();
            ...
            throw new DictionaryException("Argument is null");
        }
    }
    ...
    public Node findNode (Node root, DataKey k){
        ...
        {
            if(current.GetBirdRecord().getDataKey().compareTo(k) ==1)
            {
    ...
    public void insert(BirdRecord r) throws DictionaryException {
        ...
        if(checkNode == null){
            ...
            throw new DictionaryException("Record with same name exists"); //To change body of generated methods, choose Tools | Templates.
        }
    ...
    private Node insertRec (Node node, BirdRecord r){
        if (node == null){
            ...
            Node temp = null;
            if (r.getDataKey().compareTo(node.GetBirdRecord().getDataKey())==-1){
    ...
    public void remove(DataKey k) throws DictionaryException {
        ...
        if (delete == null){
        throw new DictionaryException("No such record key exists"); //To change body of generated methods, choose Tools | Templates.
    }
        deleteRec (delete);
    }
private void deleteRec(Node node){
    ...
    public BirdRecord successor(DataKey k) throws DictionaryException {
        ...
        if(birdKey != null){
            ...
            return tempSuccess.GetBirdRecord();
        }
    }
    ...
    public BirdRecord predecessor(DataKey k) throws DictionaryException {
        ...
        if(birdKey != null){
            ...
            return tempPrevious.GetBirdRecord();
        }
    }
